...
if (ENABLE_INTROSPECTION)
	install(FILES ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.gir
            DESTINATION ${INTROSPECTION_INSTALL_GIRDIR}
    )
install(FILES ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.typelib
...
if (ENABLE_INTROSPECTION)
    ...
    add_custom_command(
		OUTPUT ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.gir
    ...
    add_custom_command(
		OUTPUT ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.typelib
		DEPENDS ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.gir
        COMMAND ${INTROSPECTION_COMPILER} --includedir=${PROJECT_BINARY_DIR} ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.gir -o ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.typelib
        VERBATIM
    )

ADD_TYPELIB(${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.typelib)
endif ()

file(WRITE ${PROJECT_BINARY_DIR}/gtkdoc-jsc-glib.cfg
