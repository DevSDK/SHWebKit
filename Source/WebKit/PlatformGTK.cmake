...
add_custom_command(
    ...
    COMMAND glib-compile-resources --generate --sourcedir=${PROJECT_SOURCE_DIR}/Source/WebCore/Resources --sourcedir=${PROJECT_SOURCE_DIR}/Source/WebCore/platform/audio/resources --target=${DERIVED_SOURCES_WEBKIT2GTK_DIR}/WebKitResourcesGResourceBundle.c ${DERIVED_SOURCES_WEBKIT2GTK_DIR}/WebKitResourcesGResourceBundle.xml
    VERBATIM
)
...
if (ENABLE_INTROSPECTION)
    ...
    add_custom_command(
		OUTPUT ${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.gir
        DEPENDS WebKit
		DEPENDS ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.gir
        COMMAND CC=${CMAKE_C_COMPILER} CFLAGS=-Wno-deprecated-declarations LDFLAGS=
            ...
            --include=Gtk-3.0
            --include=Soup-2.4
			--include-uninstalled=${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.gir
    ...
    add_custom_command(
		OUTPUT ${PROJECT_BINARY_DIR}/WebKit2WebExtension-${WEBKITGTK_API_VERSION}.gir
		DEPENDS ${PROJECT_BINARY_DIR}/JavaScriptCore-${WEBKITGTK_API_VERSION}.gir
		DEPENDS ${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.gir
    ...
    add_custom_command(
		OUTPUT ${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.typelib
		DEPENDS ${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.gir
		COMMAND ${INTROSPECTION_COMPILER} --includedir=${PROJECT_BINARY_DIR} ${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.gir -o ${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.typelib
    )

    add_custom_command(
		OUTPUT ${PROJECT_BINARY_DIR}/WebKit2WebExtension-${WEBKITGTK_API_VERSION}.typelib
		DEPENDS ${PROJECT_BINARY_DIR}/WebKit2WebExtension-${WEBKITGTK_API_VERSION}.gir
		COMMAND ${INTROSPECTION_COMPILER} --includedir=${PROJECT_BINARY_DIR} ${PROJECT_BINARY_DIR}/WebKit2WebExtension-${WEBKITGTK_API_VERSION}.gir -o ${PROJECT_BINARY_DIR}/WebKit2WebExtension-${WEBKITGTK_API_VERSION}.typelib
    )

ADD_TYPELIB(${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.typelib)
ADD_TYPELIB(${PROJECT_BINARY_DIR}/WebKit2WebExtension-${WEBKITGTK_API_VERSION}.typelib)
endif ()

install(TARGETS webkit2gtkinjectedbundle
        DESTINATION "${LIB_INSTALL_DIR}/webkit2gtk-${WEBKITGTK_API_VERSION}/injected-bundle"
)
install(FILES "${PROJECT_BINARY_DIR}/Source/WebKit/webkit2gtk-${WEBKITGTK_API_VERSION}.pc"
	"${PROJECT_BINARY_DIR}/Source/WebKit/webkit2gtk-web-extension-${WEBKITGTK_API_VERSION}.pc"
...
if (ENABLE_INTROSPECTION)
	install(FILES ${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.gir
		${PROJECT_BINARY_DIR}/WebKit2WebExtension-${WEBKITGTK_API_VERSION}.gir
            DESTINATION ${INTROSPECTION_INSTALL_GIRDIR}
    )
install(FILES ${PROJECT_BINARY_DIR}/WebKit2-${WEBKITGTK_API_VERSION}.typelib
	${PROJECT_BINARY_DIR}/WebKit2WebExtension-${WEBKITGTK_API_VERSION}.typelib
            DESTINATION ${INTROSPECTION_INSTALL_TYPELIBDIR}
    )
endif ()

file(WRITE ${PROJECT_BINARY_DIR}/gtkdoc-webkit2gtk.cfg
    ...
    "namespace=webkit\n"
    "cflags=-I${PROJECT_SOURCE_DIR}/Source\n"
...
file(WRITE ${PROJECT_BINARY_DIR}/gtkdoc-webkitdom.cfg
